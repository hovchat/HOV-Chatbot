...
export default {
  ...
  START_OKAY: '[HOV] OK! Chúng mình sẽ thông báo khi tìm được.',
  START_WARN_GENDER: '[HOV] Lưu ý: Bạn đã không chọn giới tính. Có thể bạn sẽ phải đợi lâu hơn để tìm được người thích hợp.',
  ...
  CONNECTED: '[HOV] Đã tìm được bạn chat! Nếu muốn kết thúc, hãy gửi ketthuc',

  END_CHAT: '[HOV] Kết thúc chat!\nGửi batdau hoặc bấm vào nút để tìm bạn chat.',
  ...
  ERR_FAKE_MSG: '[HOV] Lỗi: Bạn không được giả mạo tin nhắn của HOV!',
  ...
  ERR_UNKNOWN: '[HOV] Server đã xảy ra lỗi nhưng không nghiêm trọng lắm\nHãy gửi ketthuc để thoát ra và thử lại',
};
